                ...
                <div class="modal-container">
                    ...
                    <div class="section-left">
                        ...
                        <div class="slider">
                            ...
                            <div class="slider__img-details">
                                ...
                                <ul class="slider__img-list">
                                    <div class="slider__img-list-wrap">
                                        <li
                                            class="slider__img-item active"
                                        ...
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider1.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider2.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider3.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider4.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider5.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider6.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider7.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider8.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider9.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                                        <li class="slider__img-item">
                                            <img
                                                src="./assets/img/product/slider10.avif"
                                                alt=""
                                                class="slider__img"
                                            />
                                        </li>
                        ...
                        <div class="interact">
                            <div class="interact__socials">
                                <p class="interact__socials-title">Chia sẻ :</p>
                                <img
                                    src="./assets/img/messenger.png"
                                    alt=""
                                    class="interact__social-img"
                                />
                                <img
                            ...
                            <div class="interact__like">
                                <!-- #FF424F -->
                                <svg
                                    width="24"
                                    height="20"
                                    class="interact__like-icon"
                                >
                                    <path
                    ...
                    <div class="section-right">
                        <div class="modal__content-product">
                            ...
                            <div class="modal__content-statistical">
                                <div class="modal__content-statistical-left">
                                    <div
                                        class="ratings-reviews content-separation"
                                    >
                                        <p
                                            class="ratings-reviews-quantity color-primary"
                                        >
                                            4.8
                                        </p>
                                    ...
                                    <div class="feedback content-separation">
                                        <p class="feedback-quantity">2,1k</p>
                                        <h3 class="feedback-title">Đánh giá</h3>
                                    </div>
                                    <div class="sales-info">
                                        <p class="sales-info-quantity">6,6k</p>
                                        <h3 class="sales-info-title">Đã bán</h3>
                                    </div>
                                </div>
                                <div class="modal__content-statistical-right">
                                    <p
                                        class="modal__content-statistical-report"
                                    >
                                        Tố cáo
                                    </p>
                                </div>
                            ...
                            <div class="modal__prices">
                                ...
                                <div class="anything-cheap__content">
                                    <h4
                                        class="anything-cheap__content-title color-primary"
                                    >
                                        Gì Cũng Rẻ
                                        <svg
                                            enable-background="new 0 0 15 15"
                                            viewBox="0 0 15 15"
                                            role="img"
                                            class="anything-cheap__content-img"
                                        >
                                            <circle
                                                cx="7.5"
                                                cy="7.5"
                                    ...
                                    <h4
                                        class="anything-cheap__content-desc"
                                    >
                                        Giá tốt nhất so với các sản phẩm
                                        cùng loại trên Shopee!
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal__deal">
                            <p class="modal__deal-title">Deal Sốc</p>
                            <span>Mua để nhận quà</span>
                        </div>
                        <div class="modal__quantity">
                            ...
                            <p class="modal__quantity-available">
                                123 sản phẩm có sẵn
                            </p>
                        </div>
                        ...
                        <div class="modal__buy">
                            ...
                            <button
                                class="modal__buy-btn modal__buy-btn--now"
                                type="button"
                            >
                                Mua Ngay
                            </button>
